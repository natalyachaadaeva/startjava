...
public final class Console {
    ...
    public static void printArray(float[] array, int numbersPerLine) {
    ...
    public static void printModificationResults(float[] originalArray, float[] modifiedArray, int index) {
        ...
        int zeroedCount = AllArrays.countZeroedElements(originalArray, modifiedArray);
    ...
    public static void printFactorialExpression(int[] nums, long[] factorials) {
        ...
        for (int i = 0; i < nums.length; i++) {
            ...
            if (factorials[i] == 0) {
                ...
                System.out.println(AllArrays.formFactorialExpression(n, factorials[i]));
            }
        }
    }
    ...
    public static void typeText(String textToPrint) throws InterruptedException {
